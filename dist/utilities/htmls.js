...
exports.generateTokenEmailHTML = exports.generateVerificationEmailHTML = void 0;
const generateVerificationEmailHTML = (fullname, item) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
...
const generateTokenEmailHTML = (fullname, item) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
...
exports.generateTokenEmailHTML = generateTokenEmailHTML;
//# sourceMappingURL=htmls.js.map