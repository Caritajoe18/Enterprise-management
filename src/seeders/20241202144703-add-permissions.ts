  ...
  async up(queryInterface: QueryInterface, Sequelize: typeof DataTypes) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          id: uuidv4(),
          name: "view Department Ledger",
          slug: "department-ledger",
          navParentId: navParentsMap["Department Ledger"],
          url: "department-ledger",
          orderIndex: 1,
          isNav: false,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        {
          id: uuidv4(),
          name: "Create New Weigh",
          slug: "create-weigh",
          navParentId: navParentsMap["Weighing Operations"],
          url: "create-weigh",
          orderIndex: 1,
          isNav: false,
          createdAt: new Date(),
        ...
        },
        {
          ...
          navParentId: navParentsMap["Notification"],
